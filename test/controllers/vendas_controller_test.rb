...
class VendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create venda" do
    assert_difference('Venda.count') do
      post vendas_url, params: { venda: { cliente_id: @venda.cliente_id, dt_venda: @venda.dt_venda, mercadoria: @venda.mercadoria, obs: @venda.obs } }
    end
  ...
  test "should update venda" do
    patch venda_url(@venda), params: { venda: { cliente_id: @venda.cliente_id, dt_venda: @venda.dt_venda, mercadoria: @venda.mercadoria, obs: @venda.obs } }
